...
ax1.plot(x, bass, color='r', linewidth=4, label='bubble sort assignments')
ax1.plot(x, qass, 'b', linewidth=4, label='quick sort assignments')
#ax1.plot(x, x, 'c--', label='O(N)')
ax1.plot(x,x**2, 'm--', linewidth=4, label='O(N^2)')
#ax1.plot(x,np.log10(x),'k--',label='O(logN)')
ax1.plot(x,x*np.log10(x),'k--', linewidth=4, label='O(NlogN)')
ax1.plot(x,x**3,'y--', linewidth=4, label='O(N^3)')
ax1.set_ylim([0,bass[9]*1.3])
...
ax2.plot(x, bass, 'r', linewidth=4,  label='bubble sort conditionals')
ax2.plot(x, qass, 'b', linewidth=4,  label='quick sort conditionals')
#ax1.plot(x, x, 'c--', label='O(N)')
ax2.plot(x,x**2, 'm--',linewidth=4,  label='O(N^2)')
#ax1.plot(x,np.log10(x),'k--',label='O(logN)')
ax2.plot(x,x*np.log10(x), 'k--', linewidth=4,label='O(NlogN)')
ax2.plot(x,x**3,'y--',linewidth=4, label='O(N^3)')
ax2.set_ylim([0,bass[9]*1.3])
